...
%romgen_path%\romgen %rom_path_src%\sraid3.r4   rom_cpu1     13 l r > %rom_path%\cpu1.vhd
%romgen_path%\romgen %rom_path_src%\sraid2.n4   rom_cpu2     13 l r > %rom_path%\cpu2.vhd
%romgen_path%\romgen %rom_path_src%\sraid1.m4   rom_cpu3     13 l r > %rom_path%\cpu3.vhd
