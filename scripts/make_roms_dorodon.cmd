...
%romgen_path%\romgen %rom_path_src%\dorodon.0   rom_cpu1     13 l r > %rom_path%\cpu1.vhd
%romgen_path%\romgen %rom_path_src%\dorodon.1   rom_cpu2     13 l r > %rom_path%\cpu2.vhd
%romgen_path%\romgen %rom_path_src%\dorodon.2   rom_cpu3     13 l r > %rom_path%\cpu3.vhd
